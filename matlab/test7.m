...
m=256;
n=256;
filtSigmaSquared = single(0.0015);
...
filtered256 = gather(filtered256(1:256, 1:250));
%postprocess
...
m=128;
n=128;
filtSigmaSquared = single(0.0025);
...
filtered128 = gather(filtered128(1:128,1:122));
%postprocess
...
filtered64 = gather(filtered64(1:64,1:58));
%postprocess
filtered64 = normImg(filtered64);
save('../data/data7.mat', 'noise64', 'noise128', 'noise256', 'filtered64', 'filtered128', 'filtered256', 'time64', 'time128', 'time256');
